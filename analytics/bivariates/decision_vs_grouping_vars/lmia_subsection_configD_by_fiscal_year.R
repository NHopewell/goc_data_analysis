#### lmia sub sectio config d, by fiscal year

# lmia sub section config d
sliced_data_comp %>%
  ggplot() +
...
# 2016/2017 lmia sub section config d
...
# 2017/2018 lmia sub section config d
ggplot(employer_data_comp %>%
         filter(!is.na(LMIA_Regulation_Subsection), !is.na(target_down), 
                Fiscal_Year == '17/18',
                LMIA_Regulation_Subsection %in% slice),
...
# 2018/2019 lmia sub section config d
ggplot(employer_data_comp %>%
         filter(!is.na(LMIA_Regulation_Subsection), !is.na(target_down), 
                Fiscal_Year == '18/19',
                LMIA_Regulation_Subsection %in% slice),
